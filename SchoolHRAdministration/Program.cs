...
class Program
{
    ...
    public static void SeedData(List<IEmployee> employees)
    {
        ...
        IEmployee teacher2 =
            EmployeeFactory.GetEmployeeInstance(EmployeeType.Teacher, 2, "Jenny", "Thomas", 40000);
        ...
        IEmployee headMaster =
            EmployeeFactory.GetEmployeeInstance(EmployeeType.HeadMaster, 5, "Damien", "Jones", 80000);
